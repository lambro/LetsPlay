...
class ConsolesControllerTest < ActionController::TestCase
  ...
  test "should create console" do
    assert_difference('Console.count') do
      post :create, console: { console_image: @console.console_image, console_logo: @console.console_logo, name: @console.name }
    end
  ...
  test "should update console" do
    put :update, id: @console, console: { console_image: @console.console_image, console_logo: @console.console_logo, name: @console.name }
    assert_redirected_to console_path(assigns(:console))
  end
