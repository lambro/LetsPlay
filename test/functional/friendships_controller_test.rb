...
class FriendshipsControllerTest < ActionController::TestCase
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post :create, friendship: { accepted: @friendship.accepted, usera_id: @friendship.usera_id, userb_id: @friendship.userb_id }
    end
  ...
  test "should update friendship" do
    put :update, id: @friendship, friendship: { accepted: @friendship.accepted, usera_id: @friendship.usera_id, userb_id: @friendship.userb_id }
    assert_redirected_to friendship_path(assigns(:friendship))
  end
