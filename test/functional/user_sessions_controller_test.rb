...
class UserSessionsControllerTest < ActionController::TestCase
  ...
  test "should create user_session" do
    assert_difference('UserSession.count') do
      post :create, user_session: { accepted: @user_session.accepted, gamingsession_id: @user_session.gamingsession_id, user_id: @user_session.user_id }
    end
  ...
  test "should update user_session" do
    put :update, id: @user_session, user_session: { accepted: @user_session.accepted, gamingsession_id: @user_session.gamingsession_id, user_id: @user_session.user_id }
    assert_redirected_to user_session_path(assigns(:user_session))
  end
